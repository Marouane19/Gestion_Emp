...
public class AjoutFonction extends JFrame implements ActionListener
{
  ...
  private JLabel lblDept = new JLabel("D�partement :");
  ...
  {
    // D�finition du parent
    parent = leParent;

    // Panneau pour la date
    panDate.setBorder(new TitledBorder("Date de d�but de la fonction : "));
  ...
  public void actionPerformed(ActionEvent e)
  {
    if(e.getSource() == btnOk)
    {
      ...
      dispose();
  } // Fin de la m�thode actionPerformed
  ...
  private void ajouterFonction()
  {
    ...
    catch (NumberFormatException ex)
    {
      ...
      // Initialise la date � la date actuelle
      laDate = new Date();
    }
